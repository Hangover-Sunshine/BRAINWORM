...
"OUR constitution","The NATIONAL debt is","Popular VOTING is","BIG medicaid will","COMMUNISM hates",
"Bubonic PLAGUE was","The HURRICANE","I'm a penguin!","Error 404:","You've got mail!",
"A dozen EGGS","WELFARE is theft"]
...
"A PIGGY BANK.","RIGGED for the","sell US very EVIL","TACO tuesday?","DEEP STATE ","was EDUCATED by ",
":>","User not found.",":D","are BIG PHARMA!","against the"]
...
"disguise!","SPOOKY GHOSTS.","GIMME hammer!","POPULAR?","TOASTERS!","_","propaganda!",
...
"...that freedom shall prevail","And these past 4 years have","We must elect a new president,","And now, it's time for my"]
...
"in the face of evil.","brought nothing but tyranny!","and I will take up this mantle!","uninterrupted speech..."]
